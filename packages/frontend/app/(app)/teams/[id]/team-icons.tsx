// Hand-drawn inline SVG icons for the container detail page
// (viewBox "0 0 24 24", stroke="currentColor", aria-hidden — the house icon
// rule; no icon library, no emoji glyphs).
//
// `LockIcon` and `RocketIcon` are the replacements for the 🔒 / 🚀 glyphs the
// workspace/team kind badges used to render (the 2026-09-05 emoji sweep). The
// breadcrumb's `StarIcon` is NOT here: four pages needed the byte-identical
// shape, so it graduated to `components/Icons.tsx`.
// Pure SVG — no hooks, so no "use client" directive.
