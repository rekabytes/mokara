...
<div className="mb-3">
  {" "}
  {/* no divider — divider was removed intentionally */}
...
```html
<span class="pill">member</span> <span class="pill bg-progress-soft text-progress">owner</span>
```
...
```html
<span class="badge">3</span> <span class="badge subtle">3/3</span>
```
